% ESPECTRO DE MAGNITUD AL CUADRADO DE LA SERIE DE FOURIER
% =======================================================
...
n = 1:N;
figure;
stem(n, Fn2, 'filled', 'LineWidth', 1.5);
xlabel('n');
ylabel('|F_n|^2');
title('Espectro de magnitud al cuadrado de la Serie de Fourier (N = 10)');
grid on;

% Guardar imagen para incluir en LaTeX
saveas(gcf, 'espectro_magnitud_cuadrado_N10.png');
